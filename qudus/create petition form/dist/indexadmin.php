...
if($result) {
  ...
  header('Location: http://localhost/qudus/admin/index.php');
...
<br>
          <legend><span class="number">3</span>Petition Date</legend>        
        ...
        <legend><span class="number">4</span> Petition Status</legend>
...
<label for="job">Status:</label>
 ...
 <br>
 <br>
          <legend><span class="number">5</span> Your Petition Body</legend>
